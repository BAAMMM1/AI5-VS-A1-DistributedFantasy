...
public class ErrorDelivorDTO {
    ...
    public ErrorDelivorDTO(String error, String message, Object object) {
        this.error = error;
    ...
    public class Object{
        ...
        public Object(TaskDTO.Link _links, List<Integer> deliverables, String description, int id, String location, String name, int quest, int required_players, String resource, String token) {
            this._links = _links;
        ...
        public TaskDTO.Link get_links() {
            return _links;
        }

        public void set_links(TaskDTO.Link _links) {
            this._links = _links;
        }
